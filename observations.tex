...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{Figures/Analysis_figures/Covid19_in_Czechia.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{Figures/Analysis_figures/Covid19_in_Taiwan.png}
    \caption{Relative growth and number of cases in Taiwan.}\label{fig:Taiwan}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{Figures/Analysis_figures/Covid19_in_Hong Kong.png}
